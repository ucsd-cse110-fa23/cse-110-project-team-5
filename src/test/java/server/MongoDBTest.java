...
public class MongoDBTest {
    ...
    public void testCreateRecipe() {
        mongoDB.createAndUpdateRecipe("abcd", "test name", "dinner", "test details", "0000", "test.link");
        try (MongoClient mongoClient = MongoClients.create(uri)) {
            MongoDatabase sampleTrainingDB = mongoClient.getDatabase("Pantry_Pal");
            MongoCollection<Document> usersCollection = sampleTrainingDB.getCollection("Users");
            this.user = usersCollection.find(eq("username", "abcd")).first();
    ...
    public void testUpdateRecipe() {
        mongoDB.createAndUpdateRecipe("abcd", "test update name", "dinner", "test update details", "0000", "test.link");
        try (MongoClient mongoClient = MongoClients.create(uri)) {
            MongoDatabase sampleTrainingDB = mongoClient.getDatabase("Pantry_Pal");
            MongoCollection<Document> usersCollection = sampleTrainingDB.getCollection("Users");
            this.user = usersCollection.find(eq("username", "abcd")).first();
        ...
        mongoDB.createAndUpdateRecipe("abcd", "test update name", "new tag", "new details", "0000", "test.link");
        try (MongoClient mongoClient = MongoClients.create(uri)) {
            MongoDatabase sampleTrainingDB = mongoClient.getDatabase("Pantry_Pal");
            MongoCollection<Document> usersCollection = sampleTrainingDB.getCollection("Users");
            this.user = usersCollection.find(eq("username", "abcd")).first();
    ...
    public void testReadRecipe() {
        ...
        mongoDB.createAndUpdateRecipe("test read", "test read recipe", "lunch", "test read recipe details", "0000", "test.link");
    ...
    public void testReadAllRecipes() {
        ...
        mongoDB.createAndUpdateRecipe("test7", "recipe 1", "lunch", "details 1", "0000", "test.link");
    ...
    public void testDeleteRecipe() {
        ...
        mongoDB.createAndUpdateRecipe("test delete", "recipe delete", "lunch", "details delete", "0000", "test.link");
